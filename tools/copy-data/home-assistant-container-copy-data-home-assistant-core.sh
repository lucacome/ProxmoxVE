...
# bash -c "$(curl -fsSL https://raw.githubusercontent.com/lucacome/ProxmoxVE/mainmain/tools/copy-data//home-assistant-container-copy-data-home-assistant-core.sh)"
