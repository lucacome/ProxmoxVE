...
service:
  ...
  lucacome/ProxmoxVE:
    latest_version:
      type: github
      url: lucacome/ProxmoxVE
      use_prerelease: false
    dashboard:
      icon: https://raw.githubusercontent.com/lucacome/ProxmoxVE/refs/heads/main/misc/images/logo.png
      icon_link_to: https://helper-scripts.com/
      web_url: https://github.com/lucacome/ProxmoxVE/releases
EOF
msg_ok "Setup Config"
